...
begin
  ...
  try
    ...
    qryAtualizarBanheiro.SQL.Add('EVACUACAO = :EVACUACAO, DATA_BANHEIRO = :DATA_BANHEIRO, CLIENTE_ID = :CLIENTE_ID');
...
begin
  ...
  try
    ...
    qryInserirBanheiro.SQL.Add('INSERT INTO BANHEIRO(QTD_DIURESE, QTD_EVACUACAO, DIURESE, EVACUACAO, DATA_BANHEIRO, CLIENTE_ID)');
    qryInserirBanheiro.SQL.Add('VALUES(:QTD_DIURESE, :QTD_EVACUACAO, :DIURESE, :EVACUACAO, :DATA_BANHEIRO, :CLIENTE_ID)');
